...
const triangle = (function() {
    ...
    async function typeTriangleFormula() {
        ...
        await globalFunc.HiddenElements('.traingle-inputs > div');
        await globalFunc.HiddenElements('.triangle-area > section');
    ...
    async function operationSelect() {
        ...
        if(typeFigure.value == 'triangle') {
            ...
            //imported from math-global-functions.js
            await globalFunc.HiddenElements('.triangle-info > article');
            await globalFunc.HiddenElements('.traingle-inputs > div');
            globalFunc.ClearInputs('.figure input[type="text"]');
    ...
    return {
        operationSelect,
        calcTriangleAreaByBaseAndHeight,
        calcTriangleAreaByHeronsFormula,
        calcTriangleAreaBySidesAndAngle,
