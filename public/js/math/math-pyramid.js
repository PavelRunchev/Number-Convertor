...
const pyramid = (function() {
    ...
    globalFunc.HiddenElements('.pyramid-inputs > div');
    globalFunc.HiddenElements('.pyramid-info > article');
    ...
    async function typePyramidForm() {
        ...
        await globalFunc.HiddenElements('.pyramid-inputs > div');
        await globalFunc.HiddenElements('.pyramid-info > article');
    ...
    return {
        calcSquarePyramidSurfaceArea,
        calcSquarePyramidVolume,
        calcRectangularPyramidSurfaceArea,
        calcRectangularPyramidVolume,
        calcTriangularPyramidSurfaceArea,
        calcTriangularPyramidVolume
    }
